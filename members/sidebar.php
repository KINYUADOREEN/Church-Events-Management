        ...
        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li>
                <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs">
                    <i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Manage Account
                ...
                <ul id="bs" class="collapse">
                    ...
                    <li>
                        <a href="give.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Other Givings</a>
                    </li>
                </ul>
            </li>

            <!-- Givings/Tithes Sidebar -->
            <li>
                <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1">
                    <i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Givings/Tithes
                    <div class="muted pull-right"><i class="caret"></i></div>
                </a>
            ...
            <li>
                <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs5">
                    <i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Events & Birthdays...
                    <div class="muted pull-right"><i class="caret"></i></div>
                </a>
                <ul id="bs5" class="collapse">
                    ...
                    <li>
                        <a href="massbooking.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Book Mass</a>
                    </li>
                    <li>
                        <a href="Venuebooking.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Book Venue</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="active">
                <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs4">
                    <i class="icon-chevron-right"></i><i class="icon-search icon-large"></i>&nbsp;Advance Search
                    <div class="muted pull-right"><i class="caret"></i></div>
                </a>
